    ...
    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Sign up to start using Paisa Controller
        </p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              id="email"
              type="email"
              className="block w-full pl-10 pr-3 py-2 text-black rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none"
